<?php
session_start();
    if(isset($_SESSION['login'])&& isset($_SESSION['company'])){
        $conn = new mysqli('localhost', 'root', '', '3atel');
        $qury = "SELECT * FROM company WHERE email = '".$_SESSION['company']."'";
        ...
        if($res) {
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-8 mb-5">
                                ...
                                <form method="post" action="newjob.php" class="p-5 bg-white">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-12 mb-3 mb-md-0">
                                            <label for="option-job-type-1">
                                                <input type="radio" id="option-job-type-1" value="Full Time"
                                                       name="job-type"> Full Time
                                            </label>
                                        </div>
                                        <div class="col-md-12 mb-3 mb-md-0">
                                            <label for="option-job-type-2">
                                                <input type="radio" id="option-job-type-2" value="Part Time"
                                        ...
                                        <div class="col-md-12 mb-3 mb-md-0">
                                            <label for="option-job-type-3">
                                                <input type="radio" id="option-job-type-3" value="Freelance"
                                                       name="job-type"> Freelance
                                        </div>
                                        <div class="col-md-12 mb-3 mb-md-0">
                                            <label for="option-job-type-4">
                                                <input type="radio" id="option-job-type-4" value="Internship"
                                                       name="job-type"> Internship
                                            </label>
                                        </div>
                                        <div class="col-md-12 mb-3 mb-md-0">
                                            <label for="option-job-type-4">
                                                <input type="radio" id="option-job-type-4" value="Termporary"
                                                       name="job-type"> Termporary
                                            </label>
                                        </div>
                                    ...
                                    <div class="row form-group">
                                            ...
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label for="option-job-type-1">
                                                    <input type="radio" id="option-job-type-1" value="Finance"
                                                           name="category"> Finance
                                                </label>
                                            </div>
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label for="option-job-type-2">
                                                    <input type="radio" id="option-job-type-2" value="Automotive"
                                            ...
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label for="option-job-type-3">
                                                    <input type="radio" id="option-job-type-3" value="Construction"
                                                           name="category"> Construction
                                            </div>
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label for="option-job-type-4">
                                                    <input type="radio" id="option-job-type-4" value="Telecommunications"
                                                           name="category"> Telecommunications
                                                </label>
                                            </div>
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label for="option-job-type-4">
                                                    <input type="radio" id="option-job-type-4" value="helath" name="category"> Healthcare
                                                </label>
                                            </div>
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label for="option-job-type-4">
                                                    <input type="radio" id="option-job-type-4"  value="design"name="category"> Design
                                                </label>
                                            </div>
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label for="option-job-type-4">
                                                    <input type="radio" id="option-job-type-4" value="transportation"
                                                           name="category"> transportation
                                                </label>
                                            </div>
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label for="option-job-type-4">
                                                    <input type="radio" id="option-job-type-4" value="food" name="category">
                                                    Food service
                                                </label>
                                            </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label for="option-job-type-1">
                                                    <input type="radio" id="option-job-type-1" value="entrylevel"
                                                           name="exp"> Entry Level
                                                </label>
                                            </div>
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label for="option-job-type-2">
                                                    <input type="radio" id="option-job-type-2" value="midlevel"
                                                           name="exp"> Mid Level
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label for="option-job-type-3">
                                                    <input type="radio" id="option-job-type-3" value="midseniorlevel"
                                                           name="exp"> Mid senior Level
                                            </div>
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                <label for="option-job-type-4">
                                                    <input type="radio" id="option-job-type-4" value="toplevel"
                                                           name="exp"> Top Level
                                                </label>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-12 mb-3 mb-md-0">
                                            <textarea name="jr" class="form-control" id="" cols="30"
                                                      rows="5"></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-12 mb-3 mb-md-0">
                                            <textarea name="jd" class="form-control" id="" cols="30"
                                                      rows="5"></textarea>
                                            </div>
                                        </div>
            ...
            <script type="text/javascript">
                alert("You must be registration as company");
