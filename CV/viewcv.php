...
if(isset($_GET['id'])){
    ...
    if ($conn->connect_error) {
        ...
        $qury = "SELECT * FROM candidate WHERE email = '" . $em. "'";
        $qury2 = "SELECT * FROM cv WHERE  email = '" . $em. "'";
        ...
        <div id="cv" class="instaFade">
                ...
                <button class="btn  btn-block   xon" value="Main Page" onclick="f();"> All Applicants</button>
