...
if ($conn->connect_error) {
    ...
    $qury = "SELECT * FROM job WHERE category = 'Finance'";
                ...
                <div class="site-navbar bg-light">
                    <div class="py-1">
                        <div class="row align-items-center">
                            <div class="col-2">
                                <h2 class="mb-0 site-logo"><a href="../index.html">Job<strong class="font-weight-bold">Finder</strong>
                                    </a></h2>
                            </div>
                            <div class="col-10">
                                <nav class="site-navigation text-right" role="navigation">
                                    <div class="container">
                                        ...
                                        <ul class="site-menu js-clone-nav d-none d-lg-block">
                                            <li class="active"><a href="../categories.html">For Candidates</a></li>
                                            ...
                                            <li><a href="../new=post.php"><span
                                                            class="bg-primary text-white py-3 px-4 rounded"><span
                                                                class="icon-plus mr-3"></span>Post New Job</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </nav>
        ...
        <div class="unit-5 overlay" style="background-image: url('../images/hero_1.jpg');">
            <div class="container text-center">
                ...
                <p class="mb-0 unit-6"><a href="../index.html">Home</a> <span class="sep">></span>
                    <span>Categories</span><span class="sep">></span> <span>Browse Jobs</span></p>
            </div>
        </div>
