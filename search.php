...
if(isset($_POST["title"])) {
    ...
    if ($conn->connect_error) {
        ...
        $title=$_POST["title"];
        $loc=$_POST["loc"];
        $query = "SELECT * FROM job WHERE name like '%".$title."%'";
        if($loc != null){
            $query ="SELECT * FROM job WHERE name like '%".$title."%' and location like'%".$loc."%' ";
        }
        ...
        <div class="site-wrap">
            ...
            <div class="unit-5 overlay" style="background-image: url('images/hero_1.jpg');">
                <div class="container text-center">
                    ...
                    <p class="mb-0 unit-6"><a href="index.html">Home</a> <span class="sep">></span> <span>Categories</span>
                    </p>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 mx-auto text-center mb-5 section-heading">
                            <h2 class="mb-5">available jobs</h2>
                        </div>
                    </div>
                    <div class="row">
                        <?php
                        ...
                        while(($row = $result->fetch_assoc()) !== null ) {
                            $email=$row['company'];
                            $qury2="SELECT * FROM company WHERE email = '".$email."'";
                            $res1=$conn->query($qury2);
                            $row2=$res1->fetch_assoc();
                            $cat=$row["category"];
                            $str="browsejobs.php?category=".$cat;
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 mb-3" data-aos="fade-up" data-aos-delay="100">
                                <a href="<?php echo $str?>" class="h-100 feature-item">
                                    ...
                                    <h2><?php echo $row['name'];?>  <br> <?php echo $row2['company_name'];?></h2>
                                    <h3> <?php echo $row['location']?></h3>
                                    <span class="counting"><?php echo $row['salary'];?>$</span>
                                </a>
                            </div>
                            <?php
                        }
